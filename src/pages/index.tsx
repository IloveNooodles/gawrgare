...
export default function Home() {
  return (
    <main className={ubuntuMono.className}>
      <h1>
        root@gawrgare:~# <span className={styles["span-style"]}> Whoami </span>
      </h1>
      <section className={styles.container}>
        <Image src={Gare} alt="Gare's photo" width={250} />
        <div className={styles["text-container"]}>
          <h2 className={styles.heading}>Muhammad Garebaldhie</h2>
          <p>Hello, I&apos;m Gare, a Software Engineer and Cybersecurity enthusiast</p>
          <br />
          <p>
            ...
            as an software engineer intern. Previously was working as an intern
            in{" "}
            <span>
          ...
          <p>
            ...
            listening to music, and watching movies. By far, my favorite movies
            is Interstellar and Steins;Gate
          </p>
        </div>
      </section>
    </main>
